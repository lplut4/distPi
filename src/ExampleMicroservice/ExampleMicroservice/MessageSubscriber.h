...
{
	static_assert(std::is_base_of<google::protobuf::Message, T>::value, "T must inherit from google::protobuf::Message (in other words, it must be a class generated by protoc)");
